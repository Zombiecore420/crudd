...
class ProdustosAdapter (private val mContext: Context, private val listaProductos:List<Producto>):
ArrayAdapter<Producto>(mContext,0,listaProductos){
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val imageUri=ImagenController.getImageUri(mContext,producto.idProducto.toLong())
