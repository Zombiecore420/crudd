...
class NuevoProductoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.hasExtra("producto")) {
            ...
            //-----------
            val imageUri=ImagenController.getImageUri(this,idProducto.toLong())
        ...
        save_btn.setOnClickListener {
            ...
            val descripcion = descripcion_et.toString()
            ...
            if(idProducto != null){
                ...
                CoroutineScope(Dispatchers.IO).launch {
                    ...
                    imageUri?.let {
                        ImagenController.saveImagen(this@NuevoProductoActivity,id,it)
                    }
                    this@NuevoProductoActivity.finish()
                }
            }
